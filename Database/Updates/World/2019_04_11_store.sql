...
CREATE TABLE IF NOT EXISTS `store_offer_group` (
  ...
  `category_1` int(10) unsigned DEFAULT '26',
  `category_2` int(10) unsigned DEFAULT '26',
  `category_3` int(10) unsigned DEFAULT '26',
  `c_index_1` tinyint(3) unsigned DEFAULT '0',
  `c_index_2` tinyint(3) unsigned DEFAULT '0',
  `c_index_3` tinyint(3) unsigned DEFAULT '0',
  `visible` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `FK__store_offer_group__store_category` (`category_1`),
  KEY `FK__store_offer_group__store_category_2` (`category_2`),
  KEY `FK__store_offer_group__store_category_3` (`category_3`),
  CONSTRAINT `FK__store_offer_group__store_category` FOREIGN KEY (`category_1`) REFERENCES `store_category` (`id`),
  CONSTRAINT `FK__store_offer_group__store_category_2` FOREIGN KEY (`category_2`) REFERENCES `store_category` (`id`),
  CONSTRAINT `FK__store_offer_group__store_category_3` FOREIGN KEY (`category_3`) REFERENCES `store_category` (`id`)
);

-- Dumping data for table nexus_forever_world.store_offer_group: ~350 rows (approximately)
INSERT INTO `store_offer_group` (`id`, `field_1`, `name`, `description`, `field_2`, `category_1`, `category_2`, `category_3`, `c_index_1`, `c_index_2`, `c_index_3`, `visible`) VALUES
	(0, 0, 'PLACEHOLDER', '', 0, 26, 26, 26, 0, 0, 0, 0),
	(1533, 4, 'Fortune Coins', 'Use a Fortune Coin in Madame Fay\'s Fortunes to acquire treasures and have a chance to receive rare and unique items. To spend your Coins, click on the Fortunes icon on the bottom bar of the main UI. This purchase can be spent by any character on your account when claimed.', 0, 49, 26, 26, 1, 0, 0, 1),
	(1537, 4, 'Service Tokens', 'Use Service Tokens to recustomize at the Chop Shop, manage rune slots (reroll and unlock), recover runes, bypass timers for wake here, recall, or rapid transport, and more. This purchase can be spent by any character on your account when claimed.', 0, 49, 26, 26, 2, 0, 0, 1),
	(1541, 4, 'Lockbox Keys', 'Used to open Lockboxes found at the end of Veteran Adventures, Dungeons, and Expeditions, as well as World Bosses and Discovery public events. Lockboxes contain a variety of gear from the instance in which they are found, and exclusive bonus items. This purchase can only be claimed by a single character.', 0, 49, 26, 26, 3, 0, 0, 1),
	(1545, 4, 'Character Slot Unlock', 'Adds an additional character slot to your account. This may be applied to an account twelve (12) times, allowing you to have a total of fourteen (14) total character slots unlocked. ', 0, 36, 35, 26, 4, 19, 0, 1),
	(1546, 0, 'Auctions and Bids Limit (+50)', 'Unlocks an additional 50 Auction House Auctions and 50 Auction House Bids for your account. This may be applied up to three (3) times, allowing you to have a total of 190 Auctions and 190 Bids unlocked. ', 0, 36, 35, 26, 3, 16, 0, 1),
	(1547, 0, 'Personal Bank Slot Unlock', 'Add an additional slot to your character\'s personal bank. This purchase can only be claimed by a single character and may be applied up to eight (8) times, allowing your character to have a total of ten (10) bank slots unlocked.', 0, 37, 35, 26, 8, 18, 0, 1),
	(1548, 0, 'Commodity Order Limit (+50)', 'Unlocks an additional 50 Commodity Buy Orders and 50 Commodity Sell Orders for your account. This may be applied up to three (3) times, allowing you to have a total of 190 Buy Orders and 190 Sell Orders unlocked.', 0, 36, 35, 26, 5, 21, 0, 1),
	(1549, 2, 'Holo-Wardrobe Display Limit (+100)', 'Unlocks an additional +100 Holo-Wardrobe Display slots for your account. This may be applied to an account twenty (20) times, allowing you to have a total of 2350 display slots unlocked. ', 0, 36, 35, 26, 8, 27, 0, 1),
	(1550, 0, 'Costume Slot Unlock', 'Unlocks an additional costume slot for your account. This may be applied to an account eight (8) times, allowing you to have a total of twelve (12) total costume slots unlocked. ', 0, 36, 35, 26, 6, 22, 0, 1),
	(1551, 2, 'Décor Limit (+500)', 'Increases the decor limit for your home by 500 outside and 500 inside. This license can be applied multiple times, to a maximum of 5000 (2500 inside and outside). This purchase applies to all characters on your account when claimed. ', 0, 36, 35, 26, 7, 23, 0, 1),
	(1552, 4, 'Expert Riding License', 'Increases mounted speed by 35% of the base riding skill. This purchase can only be claimed by a single character.', 0, 37, 35, 26, 10, 26, 0, 1),
	(1553, 4, 'Deluxe Upgrade Bundle', 'Missed out on the deluxe edition of WildStar? Here\'s your second chance! This bundle contains all rewards from the WildStar Deluxe edition. The items in this purchase are multi-redeem items which can be claimed by all characters on your account.', 16, 207, 50, 26, 10, 24, 0, 1),
	(1557, 2, 'Fringer Weapon Set', 'Equip the bold, roan-rustlin\' style of the Nexus frontier. This vanity weapon set contains six weapons - one for each class. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 197, 29, 27, 26, 4, 81, 0, 1),
	(1558, 0, 'Chrome Costume Set', 'Showcase your shiny, brilliant self with this six-piece costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 93, 24, 58, 1),
	(1559, 0, 'Mirrored Costume Set', 'Dazzle your friends and stun your enemies with this blindingly reflective six-piece costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 31, 66, 0, 1),
	(1560, 0, 'Shimmering Costume Set', 'A full set of heavy metal polished to the finest sheen. This costume set contains six pieces. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 92, 36, 71, 1),
	(1561, 0, 'Neapolitan Dye', 'A shaded metallic dye with tones of green and burnished copper. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 45, 87, 0, 1),
	(1562, 0, 'Topographical Dye', 'A bright blue and green metallic dye. This purchase is a multi-redeem item which can be claimed for all characters on your account.', 0, 39, 27, 26, 51, 93, 0, 1),
	(1563, 2, 'Sky Remodel - Falling into the Sun', 'Everyone loves a beautiful sunset, and it\'s even prettier when your home is actually plummeting into a star. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 6, 67, 0, 1),
	(1564, 0, 'Ground Remodel - Eldan Tech', 'A floor pattern designed with the lost architects of the universe in mind. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 4, 76, 0, 1),
	(1565, 0, 'Aurin Décor Pack', 'A full set of Aurin-designed furniture and lighting solutions for your home. This decor pack includes one (1) of all decor items shown below and can only be claimed by a single character.', 20, 80, 79, 26, 35, 36, 0, 1),
	(1611, 4, 'Flask of R&R', 'One (1) Flask. Fills your rest xp bar, up to your maximum amount of available rest experience for your current level. This purchase can only be claimed by a single character.', 0, 43, 34, 26, 2, 4, 0, 1),
	(1612, 2, 'Quantum Harvester', 'This multi-function item can be used for all harvesting tradeskills. This purchase can only be claimed by a single character.', 0, 47, 46, 26, 1, 2, 0, 1),
	(1613, 0, 'Personal Banking Terminal', 'Summons a mobile banking unit, visible only to your character. Duration: 3 minutes. This purchase can only be claimed by a single character.', 0, 44, 34, 26, 2, 8, 0, 1),
	(1614, 0, 'Personal Runecrafting Station', 'Summons a portable runecrafting station, visible only to your character. Duration: 3 minutes. This purchase can only be claimed by a single character.', 0, 26, 26, 26, 0, 0, 0, 1),
	(1615, 0, 'Character Rename Token', 'One (1) Token. To rename your character, bind the purchase to your account via the Account Inventory UI. At the character selection screen, click on Rename Character in the Account Services UI.', 0, 44, 34, 26, 3, 10, 0, 1),
	(1622, 0, 'Lawman Costume Set', 'Maintain order around Nexus with this enforcing six-piece costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 30, 65, 0, 1),
	(1623, 0, 'Outlaw Costume Set', 'On the run from the law? No problem! Get this six-piece set before you make your getaway. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 33, 68, 0, 1),
	(1624, 4, 'Gunfighter Costume Set', 'This six-piece costume set is perfect for duels in dusty abandoned streets. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 29, 64, 0, 1),
	(1625, 0, 'Exile Décor Pack ', 'A full set of Exile-built furniture and lighting solutions for your home. This decor pack includes one (1) of all decor items shown below and can only be claimed by a single character.', 27, 80, 79, 26, 45, 47, 0, 1),
	(1626, 0, 'Granok Décor Pack ', 'A full set of Granok-style furniture and lighting solutions for your home. This decor pack includes one (1) of all decor items shown below and can only be claimed by a single character.', 34, 80, 79, 26, 48, 49, 0, 1),
	(1627, 0, 'Chua Décor Pack', 'A full set of Chua-approved furniture and lighting solutions for your home. This decor pack includes one (1) of all decor items shown below and can only be claimed by a single character.', 41, 80, 79, 26, 36, 37, 0, 1),
	(1628, 0, 'Dominion Décor Pack', 'A full set of Dominion-legal furniture and lighting solutions for your home. This decor pack includes one (1) of all decor items shown below and can only be claimed by a single character.', 48, 80, 79, 26, 39, 41, 0, 1),
	(1629, 0, 'Draken Décor Pack', 'A full set of Draken-forged furniture and lighting solutions for your home. This decor pack includes one (1) of all decor items shown below and can only be claimed by a single character.', 55, 80, 79, 26, 41, 42, 0, 1),
	(1630, 0, 'Sky Remodel - Fantastic Voyage', 'Move your home to the primal logic hyperlanes with this mind-bending sky option. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 7, 68, 0, 1),
	(1631, 0, 'Sky Remodel - Proto-Pixtamatic', 'A stunning, bright, and peaceful white and blue sky for your home. Clouds not included. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 9, 70, 0, 1),
	(1632, 0, 'Ground Remodel - Asteroid ', 'Your housing plot will look like a stunning hunk of space rock when you choose this asteroid ground option. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 3, 75, 0, 1),
	(1633, 0, 'Ground Remodel - Osun Plates', 'Perfect for indoor, industrial, or mechanical plot designs while planning a blood feud against your creators. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 5, 77, 0, 1),
	(1634, 0, 'Primitech Costume Set', 'A complete Primitech costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 114, 34, 69, 1),
	(1635, 0, 'Tribaltech Costume Set', 'A complete Tribaltech costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 139, 38, 72, 1),
	(1636, 0, 'Witch Doctor Costume Set', 'A complete Witch Doctor costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 43, 77, 0, 1),
	(1637, 0, 'Rich and Famous Dye', 'Strut your stuff in this classy metallic hue that reeks of money and power. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 48, 91, 0, 1),
	(1638, 0, 'Electron Microscope Dye', 'Your style will be scrutinized when you use this bright green shade. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 40, 85, 0, 1),
	(1639, 2, 'Li\'l Scratches', 'Snuggle up with this purrfect baby pumera. Adopt Li\'l Scratches today! This purchase can only be claimed by a single character.', 0, 78, 26, 26, 23, 0, 0, 1),
	(1672, 8, 'Equivar (Midnight)', 'The epitome of cool. This hip equivar can match with the moodiest of costumes. This purchase can only be claimed by a single character.', 0, 132, 33, 31, 2, 33, 60, 1),
	(1673, 8, 'Equivar (Purple)', 'Ready to gallop across Nexus in royal style, it\'s an equivar of a different color! In this case, purple. This purchase can only be claimed by a single character.', 0, 132, 33, 31, 1, 34, 61, 1),
	(1674, 0, 'Sky Remodel - Tropical', 'Give your housing plot a perfect blue horizon to match your summer vacation holos. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 11, 72, 0, 1),
	(1675, 0, 'Sky Remodel - Vortex of Chaos', 'A swirling sky-whirlpool of madness and confusion and insanity and madness. The essence of chaos. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 13, 74, 0, 1),
	(1678, 8, 'Battlesworn Costume Set', 'You\'ll swear you\'re ready for battle with the Battlesworn costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 26, 26, 26, 0, 0, 0, 1),
	(1679, 0, 'Triton Costume Set', 'There\'s something fishy about this Ikthian-style costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 39, 73, 0, 1),
	(1680, 8, 'Freelancer Costume Set', 'Declare your independence with the Freelancer costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 26, 26, 26, 0, 0, 0, 1),
	(1683, 0, 'Veteran Costume Set', 'War never changes. That\'s where you come in, provided you\'re dressing the part with the Veteran costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 91, 40, 74, 1),
	(1684, 0, 'Dragoon Costume Set', 'Fight like one of the elite with the Dragoon costume set. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 90, 26, 60, 1),
	(1685, 0, 'Triton Weapon Set', 'Ikthian-flavored vanity weapons for every class. These items can be imported into the Holo-Wardrobe for all characters on your account.', 200, 29, 27, 26, 6, 83, 0, 1),
	(1686, 0, 'Freelancer Weapon Set', 'Freelancer-style vanity weapons for every class. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 207, 29, 27, 26, 3, 80, 0, 1),
	(1687, 0, 'Bloodforged Weapon Set', 'Mighty Osun-made vanity weapons for every class. These items can be imported into the Holo-Wardrobe for all characters on your account.', 213, 29, 27, 26, 2, 79, 0, 1),
	(1688, 4, 'Flame Dye', 'A yellow and orange hue that will light your fire. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 41, 86, 0, 1),
	(1689, 0, 'Verdigris Dye', 'Make heads turn with this vibrant gold and blue shade. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 52, 94, 0, 1),
	(1690, 0, 'Trask Tenderling', 'How can you resist that expression? He just looks so happy! Take home this adorable Trask Tenderling today! This purchase can only be claimed by a single character.', 0, 78, 26, 26, 28, 0, 0, 1),
	(1724, 8, 'Jack Shade Costume', 'Strike a frightful pose when you dress up as everyone\'s favorite holiday creep, Jack Shade. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 113, 16, 41, 1),
	(1726, 8, 'Dye Pack: Shade\'s Eve Collection', 'The haunting hues of Shade\'s Eve in one convenient pack. Includes black, purple, and orange dyes. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 132, 39, 27, 89, 53, 42, 1),
	(1727, 8, 'Ghastly Skeletal Warpig', 'This Warpig mount radiates spooky and generates horror. Get one today to haunt and torment your friends. This purchase can only be claimed by a single character.', 0, 132, 33, 31, 88, 35, 62, 1),
	(1823, 8, 'Beaksy', 'The only thing bigger than this baby ravenok\'s beak is her heart. Adopt Beaksy today!', 0, 78, 26, 26, 12, 0, 0, 1),
	(1827, 0, 'Li\'l Snuggles', 'It\'s a well known fact that baby pumeras make the best snugglers. Adopt Li\'l Snuggles today! ', 0, 132, 78, 26, 103, 1, 0, 1),
	(1831, 0, 'Little Hoof', 'This baby roan has the teensiest, tiniest hooves in all of recorded history. Adopt Little Hoof today!', 0, 78, 26, 26, 24, 0, 0, 1),
	(1833, 8, 'Rexling', 'If its arms weren\'t so stubby, this baby saurian would give you so many hugs. SO many. Adopt Rexling today!', 0, 78, 26, 26, 17, 0, 0, 1),
	(1839, 8, 'Papa Phineas Costume', 'Show your dedication to consumerism with this official Papa Phineas replica costume. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 16, 44, 97, 1),
	(1841, 8, 'Sky Remodel - Winterfest Snowfall ', 'A light snowfall is just the thing to make your housing plot feel festive. This purchase can only be claimed by a single character.', 0, 132, 81, 79, 19, 14, 66, 1),
	(1882, 8, 'Ikthian Bobberbot', 'It may not be cuddly, but it\'s definitely cute! Adopt the Ikthian Bobberbot today!', 0, 78, 26, 26, 15, 0, 0, 1),
	(1888, 8, 'Equivar (Floral)', 'If a regular equivar just isn\'t fabulous enough for you, this stylish mount may be exactly what you\'re looking for.', 0, 132, 33, 31, 3, 32, 59, 1),
	(1899, 8, 'Orbitron (Snow-Sphere) ', 'Fulfill your not-at-all-weird dream of traveling in a sno-globe with this exceedingly impractical vehicle.', 0, 132, 33, 31, 15, 49, 92, 1),
	(1909, 8, 'Sniffles', 'This chilly little ice heynar will melt your troubles away. Adopt Sniffles today!', 0, 78, 26, 26, 18, 0, 0, 1),
	(2074, 8, 'Décor Pack - Merry  Merchandise', 'Don\'t forget the true reason for the season - Papa Phineas. Show him your appreciation with this lovely collection. This décor pack includes one of all décor items shown below and can only be claimed by a single character.', 323, 132, 80, 79, 134, 79, 32, 1),
	(2076, 8, 'Protostar Holiday White Dye', 'A snowy white dye. This purchase is a multi-redeem item which can be claimed for all characters on your account.', 0, 132, 39, 27, 21, 55, 96, 1),
	(2077, 8, 'Protostar Holiday Red Dye', 'A festive red dye. This purchase is a multi-redeem item which can be claimed for all characters on your account.', 0, 132, 39, 27, 20, 54, 95, 1),
	(2080, 0, 'Velocirex (Ascendant)', 'The noble Ascendant Velocirex has been bred for generations to elicit shock, awe, and - most importantly - jealousy.', 0, 33, 31, 26, 55, 81, 0, 1),
	(2083, 8, 'Orbitron (Freelancer)', 'For those who like to live dangerously, but not too dangerously.', 0, 33, 31, 26, 43, 71, 0, 1),
	(2085, 8, 'Crate of Fireworks', 'Create your own fireworks show with this mostly legal box of explosives! This purchase can only be claimed by a single character.', 0, 132, 130, 26, 146, 17, 0, 1),
	(2089, 4, 'Décor Pack - Cuddly Collection', 'These adorable items will drastically increase the cuddly factor in your home and slightly increase the snuggle factor. This décor pack includes one of all décor items shown below and can only be claimed by a single character.', 271, 132, 80, 79, 104, 3, 4, 1),
	(2091, 8, 'Protostar Mini-House FABkit', 'This FABkit produces a cozy yet spacious Winterfest home, just the right size to hold all your fabulous gifts. This item allows multiple houses on your plot and you can continue your holiday decorations in the house interior. Once claimed, use this item in the Landscape menu of your housing lot. This purchase is for a single character only.', 0, 26, 26, 26, 0, 0, 0, 1),
	(2093, 8, 'Haunted House FABkit', 'Produces a haunted house suited for spooky housing plots, that allows an additional house on your plot that can be decorated inside and out. Once claimed, use this item to permanently unlock the Haunted House option in the Landscape menu of your housing plot. This purchase is for a single character only.', 0, 132, 82, 79, 119, 5, 78, 1),
	(2100, 8, 'Angel Costume', 'Honor the legendary Angel who saved the ancient Cassians from the Shades plague with these ethereal threads. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 112, 15, 40, 1),
	(2140, 0, 'Law Enforcement Bundle', 'You\'ll be a savvy shopper and a lethal lawbringer all at once with this bundle that contains the Lawman Costume, Topographical Dye, Blue Road Render, 9 Fortune Coins, and 30 Service Tokens. This Costume and Dye can be imported into the Holo-Wardrobe and used for all characters on your account.', 15, 207, 50, 26, 13, 38, 0, 1),
	(2141, 0, 'Speed Freak Bundle', 'Those freaky Dreg may not know much about math, or science, or hygiene - but they know a good deal when they see it! Get a speedy Red Dreg Racer, an Expert Riding License to permanently boost your mount speed, and 3 Fortune Coins. This purchase can only be claimed by a single character.', 13, 207, 50, 26, 19, 40, 0, 1),
	(2144, 0, 'Fateful Fortune Bundle', 'Face your fate and find a fortune (or three) with this mystically magnificent bundle containing the Witch Doctor\'s Costume, Neapolitan Dye, 30 Service Tokens, and 3 Fortune Coins. This Costume and Dye can be imported into the Holo-Wardrobe and used for all characters on your account.', 14, 207, 50, 26, 18, 36, 0, 1),
	(2242, 8, 'Fawngrazer', 'Fun fact: This little dawngrazer\'s eyes can see into your very soul. Adopt Fawngrazer today!', 0, 78, 26, 26, 13, 0, 0, 1),
	(2245, 0, 'Techno-Phage Bobberbot', 'It\'s trying to look tough, but that just makes it even cuter. Adopt the Techno-Phage Bobberbot today!', 0, 78, 26, 26, 27, 0, 0, 1),
	(2278, 2, 'Title: Smart Shopper', 'You know you\'re a smart shopper - now show everyone else with this inexpensive yet stylish title!', 0, 212, 26, 26, 4, 0, 0, 1),
	(2391, 0, 'Dread Mantis Costume Set', 'The perfect marriage of technology and nature. Creepy, weird, dangerous nature.  These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 87, 27, 61, 1),
	(2392, 8, 'Wild Woolie', 'Stripes are in this season! And every other season, because they\'re permanent. ', 0, 132, 33, 31, 32, 56, 83, 1),
	(2409, 0, 'Centurion Wing Costume Set', 'The cybernetic enhancements are cool and all, but the best part of this armor is the ability to show off your sweet biceps. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 132, 28, 27, 86, 23, 57, 1),
	(2414, 8, 'Pot O\' Shinies', 'Typically these sorts of things go at the end of a rainbow, but Lopp have no concern for tradition so put it wherever you want! This purchase can only be claimed by a single character.', 0, 132, 130, 26, 147, 12, 0, 1),
	(2416, 0, 'Creature Décor - Draken Hunter Pack', 'Six (6) Draken hunters in various poses of interest. This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 118, 80, 79, 26, 42, 43, 0, 1),
	(2417, 0, 'Creature Décor - Draken Huntress Pack', 'Six (6) Draken huntresses in various poses of interest. This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 115, 80, 79, 26, 43, 44, 0, 1),
	(2418, 8, 'Spring Décor Bag', 'This massive bundle contains over 30 décor items for creating the perfect spring garden, including flowers, white picket fences, arbors, a tea set and even rainbows! This purchase can only be claimed by a single character.', 0, 80, 79, 26, 56, 56, 0, 1),
	(2419, 0, 'Décor Pack - Lopp Village', 'Lopp love life. Lopp love shinies. You love shinies? Lopp love you! Lots of Lopp to love in shiny Lopp Villagepack. Listen to Lopp, yes? Yes. This décor pack includes one of all décor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 50, 51, 0, 1),
	(2428, 8, 'Kroggenbull', '"Hey, you got Krogg in my Snarfelynx! You got Snarfelynx in my Krogg!" And that\'s probably how it happened. ', 0, 26, 26, 26, 0, 0, 0, 1),
	(2431, 0, 'Trask (Strain)', 'Sure it\'s unruly, dangerous, sticky, and kind of gross-looking, but on the bright side, it… uh… I forgot where I was going with this. ', 0, 33, 31, 26, 54, 80, 0, 1),
	(2437, 0, 'Moodie Hoverboard', 'This priceless relic,  once worn by a powerful Moodie shaman, was said to possess mystic healing properties. Then we turned it into a hoverboard!', 0, 32, 31, 26, 14, 64, 0, 1),
	(2440, 0, 'Doggie Dasher', 'Horsepower is so last century. Dogpower is the new standard for traveling at maximum cuteness levels.', 0, 32, 31, 26, 9, 56, 0, 1),
	(2452, 0, 'Turtoggles', 'He may not be conventionally cute, but just watch him chase after you on those stumpy legs and see if you can resist his charms. Adopt Turtoggles today!', 0, 78, 26, 26, 29, 0, 0, 1),
	(2455, 8, 'Hornsworth', 'With his adorable ears, teeny tail, slick mohawk, and rugged horns,  this baby Oxian has found the perfect balance of "cute" and "cool." Adopt Hornsworth today!', 0, 78, 26, 26, 14, 0, 0, 1),
	(2461, 8, 'Pebbleback', 'She may be a little shy, but little Pebbleback is definitely a diamond in the rough! Adopt Pebbleback today!', 0, 78, 26, 26, 16, 0, 0, 1),
	(2464, 0, 'Snowman\'s Land FABkit', 'Produces a winter wonderland on your housing plot. Once claimed, use this item to permanently unlock the Snowman\'s Land option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 7, 64, 0, 1),
	(2465, 4, 'Bird House FABkit', 'Unlocks the Bird House option for your housing plot, complete with remodel options. Once claimed, use this item in the Landscape menu of your housing plot. This purchase is for a single character only. ', 0, 82, 79, 26, 3, 61, 0, 1),
	(2466, 0, 'Darkspur Platform FABkit ', 'Produces a Darkspur Platform on  your house plot. Once claimed, use this item to permanently unlock the Darkspur Platform option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 4, 62, 0, 1),
	(2467, 0, 'Holo Display Décor Pack', 'Holo screens in a plethora of colors. That\'s right, a plethora. This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 49, 50, 0, 1),
	(2468, 0, 'Decorative Flames Décor Pack', 'If you\'ve ever looked at your housing plot and thought "Not enough of this is on fire," then today is your lucky day. This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 37, 38, 0, 1),
	(2469, 0, 'Smoke Décor Pack', 'They say "where there\'s smoke, there\'s fire." Joke\'s on them though, because now you can get all the smoke you want without any of that pesky fire. This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 55, 55, 0, 1),
	(2470, 2, 'Protostar Insta-Hills Décor Pack', 'Instantly create hills that match the terrain of your housing plot thanks to new innovations from Protostar!  This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 52, 53, 0, 1),
	(2471, 2, 'Pink Bubblegum Dye', 'A color not unlike the chewed-up bubblegum you stuck under your desk that one time. Yeah, you thought no one saw that, didn’t you? This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 47, 90, 0, 1),
	(2472, 0, 'Orange Black Skyfire Dye', 'A dye the color of a dying star that will soon implode and turn into a black hole, destroying everything for millions of miles. Romantic! This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 46, 89, 0, 1),
	(2473, 0, 'Teal Underglow Dye', 'This sleek dye will give you a tech-savvy look without any of the work of actually being tech-savvy. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 50, 92, 0, 1),
	(2474, 0, 'Osun Statue Disguise', 'Nothing to see here. Just a totally innocuous statue. Feel free to let your guard down. This purchase can only be claimed by a single character.', 0, 130, 26, 26, 11, 0, 0, 1),
	(2475, 0, 'Lopp Disguise', 'You know you want to be a Lopp. Who doesn\'t? With this disguise, you\'re one step closer to achieving your dream! This purchase can only be claimed by a single character.', 0, 130, 26, 26, 10, 0, 0, 1),
	(2495, 0, 'Fanciful Vees Bundle', 'Enjoy five (5) fanciful vees at a bargain price.', 0, 26, 26, 26, 0, 0, 0, 1),
	(2496, 0, 'Fanciful V-Shirt', '', 0, 215, 27, 26, 10, 62, 0, 1),
	(2502, 0, 'Timesaver Bundle', 'You\'ve got things to do. Important things. Things that require you to be a higher level. Get there faster with this convenient Timesaver Bundle! Contains five (5) Flasks of R&R and Flasks of Advancement (3H). The items in this bundle can only be claimed on a single character. ', 10, 212, 207, 50, 2, 9, 23, 1),
	(2506, 0, 'Collectors Pack: Renders', 'Why choose when you can have them all? For a limited time only gain access to each and every Road Render for one low price. This purchase can only be applied to a single character.', 12, 26, 26, 26, 0, 0, 0, 1),
	(2507, 0, 'Collectors Pack: Racers', 'Are you ready to race? For a limited time only take home two Dreg Racers for one low price. This purchase can only be applied to a single character.', 12, 26, 26, 26, 0, 0, 0, 1),
	(2508, 0, 'Collectors Pack: Trasks', 'Why choose when you can have them all? For a limited time only gain access to our entire stable of Trasks for one low price. This purchase can only be applied to a single character.', 12, 26, 26, 26, 0, 0, 0, 1),
	(2509, 0, 'Newly Hatched Bundle', 'Nexus can be intimidating, especially when you\'re just starting out. Well the Newly Hatched Bundle is here to help! With two (2) personal bank slots, one (1) personal banking terminal, one (1) quantum harvester, and one(1) Beaksy companion pet, you\'ll be ready for anything!', 325, 212, 207, 50, 1, 3, 22, 1),
	(2510, 0, 'Ikthian Deepwalker', 'An eight-legged ground mount of Ikthian design. Its appearance is based on life forms native to Ikthia.', 0, 33, 31, 26, 37, 67, 0, 1),
	(2513, 0, 'Big Burny', 'What\'s a little fire among friends? Adopt Big Burny today!', 0, 78, 26, 26, 19, 0, 0, 1),
	(2516, 8, 'Jungle Trask', 'A striped exotic Trask, with tipped tail, spikes, and feet. Includes rustic saddle. ', 0, 132, 33, 31, 4, 38, 6, 1),
	(2527, 8, 'Jungle Trask (Blurple)', 'Take a ride on the wild side, with this blurple-striped trask. Includes rustic saddle. ', 0, 132, 33, 31, 7, 39, 1, 1),
	(2530, 8, 'Jungle Trask (Pinkbelly)', 'Be bold and show questionable taste. Take this unusual pink, green, and blue trask home today! ', 0, 132, 33, 31, 6, 40, 2, 1),
	(2533, 8, 'Jungle Trask (Toxic)', 'This blue-striped trask has a yellow tips on its tail, spikes, and feet. Do not eat. ', 0, 132, 33, 31, 5, 41, 5, 1),
	(2536, 0, 'Road Render (Blue)', 'Cruise around Nexus in this blue hot rod. Features a custom upholstered seat for long journeys. ', 0, 132, 33, 31, 85, 45, 74, 1),
	(2539, 0, 'Road Render (Green)', 'Cruise around Nexus in this green hot rod. Features a custom upholstered seat for long journeys. ', 0, 132, 33, 31, 84, 46, 73, 1),
	(2542, 0, 'Road Render (Pink)', 'Cruise around Nexus in this pink hot rod. Features a custom upholstered seat for long journeys. ', 0, 132, 33, 31, 83, 47, 75, 1),
	(2545, 0, 'Road Render (Red)', 'Cruise around Nexus in this red hot rod. Features a custom upholstered seat for long journeys. ', 0, 132, 33, 31, 82, 48, 76, 1),
	(2548, 0, 'Dreg Racer (Red)', 'Trailblaze across Nexus on this tech-infused hover mount adorned with bones, tusks, skulls, spikes, and a lot of mysterious red. Best not to ask where that came from. ', 0, 33, 31, 26, 31, 58, 0, 1),
	(2551, 0, 'Dreg Racer', 'Trailblaze across Nexus on this tech-infused hover mount adorned with bones, tusks, skulls, and spikes.', 0, 33, 31, 26, 30, 57, 0, 1),
	(2572, 0, 'Housewarming Party Bundle', 'Warm up your housing plot with the fun-filled Arborian Festival and tropical sky. Available for a limited time at a low introductory rate!', 0, 80, 79, 50, 33, 25, 21, 1),
	(2573, 0, 'Buzzbing Yellow Dye', 'Your friends will be all abuzz when you don this sporty shade!', 0, 39, 27, 26, 39, 84, 0, 1),
	(2580, 4, 'Flask of Advancement', '  Increases experience gains by 50% during normal gameplay. Flask buffs do not count down while logged out.', 0, 43, 34, 26, 1, 1, 0, 1),
	(2587, 0, 'Flask of Riches', 'Increases currency, renown, and prestige gained by 25%. Flask buffs do not count down while logged out. This purchase can only be claimed by a single character.', 0, 43, 34, 26, 1, 6, 0, 1),
	(2594, 0, 'Flask of Fame', 'Increases reputation gains by 100% during normal gameplay. Flask buffs do not count down while logged out.', 0, 43, 34, 26, 1, 2, 0, 1),
	(2601, 0, 'Flask of the Harvest', 'A 10% chance to receive extra materials when harvesting. Flask buffs do not count down while logged out. Each flask in this purchase can only be claimed by a single character.', 0, 43, 34, 26, 1, 3, 0, 1),
	(2608, 0, 'Flask of Reward', 'Increases contract, challenge and zone reward points by 50%. Flask buffs do not count down while logged out.', 0, 43, 34, 26, 1, 5, 0, 1),
	(2615, 0, 'Adventure Pack', 'Prepare for your adventures on Nexus with this hearty pack of supplies. Includes 2 Extra Character Slots, 1 Extra Bank Slot, 3 Fortune Coins, a unique equipped, multi-redeem 16 slot bag, multi-redeem pet, and the Fringer weapon set.', 13, 207, 50, 26, 6, 17, 0, 1),
	(2629, 0, 'Captain\'s Pack', 'This bundle features everything but the kitchen sink for the spacefarer in search of a mobile home. Planters, plants, treadmill, and the all-important captain\'s chair await you inside the Royal Piglet House.', 325, 207, 50, 26, 5, 16, 0, 1),
	(2630, 0, 'Cute & Cuddly Pack', 'This bundle features all things cute and cuddly with both GlitterKitty Cruiser and Snarfelynx mounts. But wait—there\'s more! A pet and matching plushie, comfy cushions, and, oh, the Bird House!', 325, 207, 50, 26, 4, 15, 0, 1),
	(2631, 0, 'Monkey King Armor', 'Dress like a king with this exotic outfit reminiscent of the legendary Monkey King! These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 32, 67, 0, 1),
	(2632, 0, 'King Jake', 'Finally—a companion to go bananas for! Take King Jake home today!', 0, 78, 26, 26, 20, 0, 0, 1),
	(2635, 0, 'Traditional Dress', 'This store exclusive outfit is spun of red and golden threads, truly a feast for the eyes! These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 37, 70, 0, 1),
	(2640, 0, 'To Dye For Bundle', 'Looking for a nice cross section of color? Look no further! For the first time ever, Flame, Verdigris, and Neapolitan dyes are available in a single bundle! This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 37, 51, 0, 1),
	(2641, 0, 'Exotic Décor Pack', 'Enhance your house with this exotic décor set. This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 47, 48, 0, 1),
	(2644, 0, 'Monkey King Hoverboard', 'Who needs a road when you can be king? Monkey King, that is!', 0, 32, 31, 26, 13, 70, 0, 1),
	(2664, 0, 'Procured Genesis Key', 'In a hurry to finish attunement? One (1) Procured Genesis Key. Used to complete the raid attunement process. This purchase can only be claimed by a single character.', 0, 37, 35, 26, 11, 28, 0, 1),
	(2665, 1, 'Strain Jabbit', 'If the Trask Tenderling is cute, the Strain Jabbit is the point farthest from. But even we couldn\'t resist when a tear fell from its singular enlarged eye. Note: Do not feed.', 0, 78, 26, 26, 26, 0, 0, 1),
	(2668, 8, 'Snarfelynx (Beach)', 'The Beach Snarfelynx is too cool for school. It\'s also too cool for pants. But not too cool to give you a ride.', 0, 33, 31, 26, 50, 78, 0, 1),
	(2671, 0, 'Kel Havik Blue Dye', 'Sink into a relaxing aquamarine hue reminiscent of primal ice floating in a drink that comes with tiny little umbrella. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 43, 88, 0, 1),
	(2674, 0, 'Bodacious Beachwear', 'Get ready for summer with some Bodacious Beachwear. Fashion statement items at bargain prices! These items can be imported into the Holo-Wardrobe for all characters on your account. These items are not currently dyeable.', 1625, 28, 27, 26, 21, 56, 0, 1),
	(2681, 0, 'Summer Décor Pack', 'Celebrate summer with some piping hot décor. The Summer Décor Pack comes complete with everything you need to start an awesome beach party. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 26, 26, 58, 0, 0, 1),
	(2685, 0, 'Beach Bash Boombox Toy', 'Lookin\' for some tunes to make your beach party complete? Then look no further! The Beach Bash Boombox is here to cure your ills! This purchase can only be claimed by a single character.', 0, 130, 26, 26, 7, 0, 0, 1),
	(2718, 4, 'Character Boost Token', 'Create a new level 50 character for your account! To use this token, select the \'Create a New Level 50 Character\' button in the character selection UI. The token cannot be used on pre-existing characters.', 0, 76, 37, 35, 4, 4, 12, 1),
	(2720, 0, 'Aurin Engineer Creation Unlock', 'Unlocks the ability to create Aurin Engineers on your account. Unlocked race/class combinations will be available at the character select screen immediately after purchase.', 0, 36, 35, 26, 1, 17, 0, 1),
	(2721, 0, 'Chua Warrior Creation Unlock', 'Unlocks the ability to create Chua Warriors on your account. Unlocked race/class combinations will be available at the character select screen immediately after purchase.', 0, 36, 35, 26, 2, 20, 0, 1),
	(2722, 0, 'Darkspur Duds', 'Dress like a Cartel criminal and steal your way into another\'s heart. Or purse. Or house! These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 25, 59, 0, 1),
	(2723, 8, 'Trask (Darkspur)', 'The Darkspur Trask is bred to fight dirty. Once it smells fear, there ain’t no chains on Nexus strong enough to hold it back.', 0, 132, 33, 31, 8, 52, 3, 1),
	(2726, 0, 'Mookie', 'Mookie was rescued from the fighting pits in a backwater asteroid belt not far from Nexus. Do not remove mask!', 0, 78, 26, 26, 25, 0, 0, 1),
	(2729, 0, 'Wedding Tux', 'Ce-le-brate good times with this distinquished take on a tuxedo. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 42, 76, 0, 1),
	(2730, 0, 'Wedding Gown', 'Celebrate good times with this beautiful gown! These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 41, 75, 0, 1),
	(2734, 8, 'Trask (Dreg)', 'Dreg aren’t picky about who they eat, and neither is this trask... so be careful!', 0, 132, 33, 31, 9, 53, 4, 1),
	(2768, 0, 'Chompushanka', 'Eat or be eaten? Display your Chompie pride with this adorable orange head adornment. This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 215, 27, 26, 4, 39, 0, 1),
	(2772, 1, 'Monkey King Weapons', 'Fight like a king with these exotic weapons reminiscent of the legendary Monkey King! These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 29, 27, 26, 5, 82, 0, 1),
	(2773, 0, 'Housing Sky - Two Suns', 'Why settle for one when you can have two - suns, that is! Don\'t worry about the debris… Protostar housing technology is completely safe. Really.', 0, 81, 79, 26, 12, 73, 0, 1),
	(2774, 0, 'Redmoon Bar Décor Pack', 'The Redmoon Marauders don\'t leave survivors unless you\'re willing to serve them up some good grub.  The Redmoon Bar Décor Pack comes with everything you need to make even the worst examples of scum and villiany feel right at home.', 0, 80, 79, 26, 53, 54, 0, 1),
	(2775, 0, 'Pumera (Hardlight)', 'Is it real or is it hologram? Hunt by the light of your mount with the Hardlight Pumera!', 0, 33, 31, 26, 44, 72, 0, 1),
	(2778, 0, 'Waterfall Décor Pack', 'Longing to create a tropical paradise? We\'ve got you covered! The Waterfall Décor Pack contains the following: four (4) new waterfall variants, two (2) flitterfly FX, and a generous assortment of aquatic plant life.', 0, 80, 79, 26, 64, 59, 0, 1),
	(2779, 0, 'Snarf o\' Nine Tails Bundle', 'There are many Snarfelynxes in this world… and they can all be yours. The Snarf o\' Nine Tails Bundle contains one (1) each of the following: Snarfelynx, Snarfelynx (Strain), and Snarfelynx (Summer). This purchase is a multi-redeem item which can be claimed for all characters on your account.', 0, 50, 33, 31, 8, 28, 51, 1),
	(2780, 0, 'Woolie (Dream)', 'The first reports of this creature were dismissed as tall tales. Thankfully it turned out to be quite substantial. Finally everyone can live out their dreams astride the beautiful Dream Woolie. ', 0, 132, 33, 31, 31, 27, 46, 1),
	(2783, 8, 'Safety Dancer Costume', 'The Safety Dancer costume was created for those who want to take a chance and dance… if they want to. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 26, 26, 26, 0, 0, 0, 1),
	(2787, 0, 'Topiary Decor Pack', 'What housing plot couldn\'t use some additional landscaping? Perhaps a topiary or three? That\'s right, it\'s time to make that hedge maze you\'ve always wanted. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 26, 26, 60, 0, 0, 1),
	(2788, 0, 'Topiary Décor Pack (Autumn)', 'Everyone\'s favorite landscaping pack is back - with an autumn hue. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 26, 26, 61, 0, 0, 1),
	(2789, 0, 'Leeloo', 'While Leeloo the Corgun cannot speak if you get thrown down a well, she WAS created with an overabundance of enthusiasm and cuteness.', 0, 78, 26, 26, 22, 0, 0, 1),
	(2792, 0, 'Darkspur Bundle', 'That\'s right - all of the new Darkspur items together for one low price. This bundle contains the following: one (1) Trask (Darkspur), one (1) Mookie, one (1) Darkspur Duds. The items in this bundle are either multi-redeem items that can be claimed for all characters on your account or items that may be imported into the Holo-Wardrobe for all characters on your account.', 0, 50, 26, 26, 4, 0, 0, 1),
	(2796, 0, 'Arcade Carpet Pack', 'The Arcade Carpet Pack contains everything you need to create a whimsical floor. This purchase can only be claimed by a single character.', 0, 80, 79, 26, 34, 26, 0, 1),
	(2799, 0, 'Ability Tier Point Unlock', 'Need an Ability Tier Point but short on in-game currency? We\'ve got your back!', 0, 37, 35, 26, 6, 14, 0, 1),
	(2803, 0, 'AMP Power Upgrade', 'Need an AMP Power Upgrade but short on in-game currency? We\'ve got your back!', 0, 37, 35, 26, 7, 15, 0, 1),
	(2807, 0, 'AMP & Ability Bundle', 'Find yourself in need of a little of everything? This bundle contains the following items: five (5) AMP Power Upgrades, five (5) Ability Tier Point Unlocks.', 0, 37, 35, 26, 5, 13, 0, 1),
	(2808, 0, 'Character Boost Bundle', 'Ready to make an alt? The Character Boost Bundle contains the following: one (1) Character Boost Token, seven (7) Ability Tier Point Unlocks, 10 AMP Power Upgrades.', 0, 37, 35, 26, 3, 10, 0, 1),
	(2813, 0, 'Hoverboard (Summer)', 'Prepare for tubular coolness! The Summer Hoverboard is two parts water pistol, one part flotation device and radically fun. ', 0, 32, 31, 26, 16, 79, 0, 1),
	(2816, 0, 'Retris Block Sampler Pack', 'All new neon colored block décor for your building pleasure! This décor pack contains one (1) of each type of Retris block.', 0, 80, 26, 26, 54, 0, 0, 1),
	(2817, 0, 'Betsy\'s Kite', 'A delicate blue kite to play with during warm summer weather. Warning: Don\'t get it wet!', 0, 130, 26, 26, 8, 0, 0, 1),
	(2818, 0, 'Doggie Dasher Ultra Bundle', 'At last! The Doggie Dasher hoverboard and Leeloo are available together. Don\'t let this opportunity dash away!', 0, 50, 32, 31, 5, 7, 52, 1),
	(2821, 0, 'Super Celebratory Pack', 'Everything you need for the ultimate celebration! This offer contains one (1) of each of the following: Wedding Dress, Wedding Tux, and the Spring Décor Pack.', 0, 50, 26, 26, 9, 0, 0, 1),
	(2823, 0, 'Ikthian Bundle', 'Time to get fishy with it! This offer contains one (1) of each of the following: Triton Costume and Triton Weapons. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 50, 26, 26, 7, 0, 0, 1),
	(2824, 0, 'Dominion Builders Kit', 'A sampler pack of equisitely crafted Dominion architecture for your housing plot.', 0, 80, 79, 26, 38, 39, 0, 1),
	(2828, 0, 'Sandcastle Sampler Pack', 'Build your own castle - sandcastle, that is! This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 1, 1, 0, 1),
	(2829, 0, 'Shadow Warrior Costume', 'Strike from the shadows in this 100% authentic ninja outfit. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 35, 48, 0, 1),
	(2830, 0, 'Street Curb Sampler Pack', 'Don\'t let builders block kick you to the curb - unless it\'s street curbs! This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 57, 57, 0, 1),
	(2831, 0, 'Eldan Trim Sampler Pack', 'This pack has all the trimmings. Eldan trimmings that is! This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 44, 45, 0, 1),
	(2832, 0, 'Grimvault Violet Dye', 'A succulent purple dye unlike any other. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 42, 50, 0, 1),
	(2833, 0, 'Skurge Blue Dye', 'A cooling blue dye that will leave your wardrobe felling refreshed. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 49, 24, 0, 1),
	(2834, 0, 'Luminous Ocher Dye', 'A spicy orange dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 44, 38, 0, 1),
	(2835, 0, 'Burning Terra Dye', 'Tired of wiping dried blood off of your armor? Then is this the dye for you! This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 38, 21, 0, 1),
	(2839, 0, 'Trains of Nexus Sampler Pack', 'All aboard for some locomotive fun! This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 63, 58, 0, 1),
	(2840, 0, 'Dominion Citizen Decor Pack', 'Outfit your housing plot with a full contingent of Dominion Citizens! This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 40, 40, 0, 1),
	(2841, 0, 'Exile Citizen Décor Pack', 'Outfit your housing plot with a full contingent of Exile Citizens! This decor pack includes 1 (1) of all decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 46, 46, 0, 1),
	(2842, 0, 'Nexfro Hat', 'Take your hairstyle to the EXTREME with the Nexfro Hat. This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 215, 27, 26, 7, 47, 0, 1),
	(2843, 0, 'Clown Hair', 'Quit clownin\' around and put this on yer head! This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 215, 27, 26, 5, 46, 0, 1),
	(2844, 0, 'Road Hazard Headgear', 'Ain\'t no emergency like a fashion emergency! This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 215, 27, 26, 8, 45, 0, 1),
	(2846, 0, 'Shellark Hat', 'Adorn your locks with this monstrously cute hat! This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 215, 27, 26, 9, 43, 0, 1),
	(2860, 0, 'Trapper\'s Togs Costume Set', 'The Trapper\'s Togs Costume Set is guaranteed to see you through lean times without resulting to questionable survival tactics. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 14, 37, 0, 1),
	(2861, 0, 'Girrok (Loftite)', 'Brave the wilds of Nexus astride your very own loftite infused Girrok. Disclaimer: Does not float.', 0, 33, 31, 26, 26, 45, 0, 1),
	(2864, 0, 'Hoverboard (Skate-or-Die)', 'Practice some slick moves while flying with steeze aboard the Skate-or-Die hoverboard.', 0, 32, 31, 26, 15, 44, 0, 1),
	(2867, 0, 'Autumn Park FABkit', 'Enjoy fall colors (and feed cute wildlife) from the safety of your own home. Once claimed, use this item to permanently unlock the Autumn Park option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 2, 60, 0, 1),
	(2915, 8, 'Dark Delights Decor Pack', 'The Dark Delights décor pack contains everything you need to perform your own ritual of questionable intent (haunted trees and creepy eyes included!). This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 26, 111, 28, 0, 1),
	(2916, 8, 'Faces of Shades Eve Décor Pack', 'The face is the thing! The Faces of Shades Eve décor pack contains a myriad of masks and a plethora of grimgourds. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 26, 115, 29, 0, 1),
	(2917, 8, 'Graveyard Decor Pack', 'Gothic statues, check. Horrific trees, check. The Graveyard Décor Pack contains everything you need to create a nice, quiet gothic exterior for the recently (and not-so-recently) departed. Ghosts not included. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 26, 116, 30, 0, 1),
	(2918, 8, 'Haunted Hayride Décor Pack', 'Grimgourds, effigies, and hayride wagons oh my! This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 26, 117, 31, 0, 1),
	(2919, 8, 'Spooky Lighting Decor Pack', 'Shades Eve is a time for thrills, chills, and home decorating contests. The Spooky Lighting décor pack offers the complete collection of Shade\'s Eve themed lighting decorations. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 26, 118, 32, 0, 1),
	(2946, 0, 'Gummilynx (Rapple)', 'Tart and sweet, the Rapple Gummilynx is a treat to ride.', 0, 33, 31, 26, 21, 37, 0, 1),
	(2949, 0, 'Gummilynx (Bingberry)', 'Sweet and spicy with notes of hidden citrus, the Bingberry Gummilynx is a feast for the senses.', 0, 33, 31, 26, 25, 38, 0, 1),
	(2952, 0, 'Gummilynx (Concord)', 'The Concord Gummilynx is awash in decadent color. This mount is truly bursting with flavor!', 0, 33, 31, 26, 24, 39, 0, 1),
	(2955, 0, 'Gummilynx (Loppfruit)', 'The green topped and yellow bellied Loppfruit Gummilynx is a sight for sore eyes (and bums).', 0, 33, 31, 26, 23, 40, 0, 1),
	(2958, 0, 'Gummilynx Bundle', 'Gotta ride \'em all? The Gummilynx Bundle is here for you!', 0, 26, 26, 26, 0, 0, 0, 1),
	(2961, 0, 'Winter Topiary Pack', 'Everyone\'s favorite landscaping pack is back - with a wintery touch. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 26, 26, 62, 0, 0, 1),
	(2962, 0, 'Makin\' Tracks Décor Pack', 'Sometimes you\'ve just got to make tracks. This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 51, 52, 0, 1),
	(2963, 0, 'Highfalutin\' Gambler\'s Costume Set', 'The Highfalutin\' Gambler\'s Costume set is for those who know how to hold \'em. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 13, 23, 0, 1),
	(2967, 0, 'Go-Go Costume Set', 'Get ready to go-go! Caution: This costume may cause the wearer to boogiloo until they puke. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 12, 22, 0, 1),
	(2968, 8, 'Decor Pack - Cozy Decorations', 'It\'s time to get ready for the holidays! Hang stockings, trim a tree shelf, and cuddle up by a nice warm fire. This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 26, 8, 6, 1),
	(2969, 8, 'Decor Pack - Bountiful Branding', 'The Bountiful Branding décor pack contains a collection of exquisitely crafted, Protostar branded merchandise... for money! This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 318, 132, 80, 79, 25, 7, 5, 1),
	(2970, 8, 'Decor Pack - Jolly Holiday', 'Get your yard ready for a jolly holiday season! This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 322, 132, 80, 79, 23, 6, 7, 1),
	(2971, 8, 'Decor Pack - Winter Wonderland', 'The Winter Wonderland décor pack contains everything you need to create a glacial paradise. This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 24, 5, 9, 1),
	(2972, 8, 'Decor Pack - Seasonal Advertising', 'What\'s the point of having a holiday without tasteful and seasonally appropriate advertisements? This décor pack includes all of the décor items shown below and can only be claimed by a single character.', 324, 132, 80, 79, 22, 4, 8, 1),
	(2973, 0, 'Hoverboard (Berserker)', 'Ride like a rebel aboard the Berserker Hoverboard!', 0, 32, 31, 26, 2, 31, 0, 1),
	(2985, 0, 'Tacky Winterfest Sweater', 'A tacky Winterfest sweater. This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 215, 27, 26, 2, 25, 0, 1),
	(2987, 8, 'Icequivar', 'This ride is so chill it’s frozen - so get your insulated saddle ready and ride out Winterfest in style!', 0, 26, 26, 26, 0, 0, 0, 1),
	(2993, 0, 'Pandalynx', 'Fluffiest of fur? Check. Adorable tail nub, Double check. The Pandalynx is the rarest and most exotic member of the Snarf family. Get \'em before they\'re gone!', 0, 33, 31, 26, 18, 33, 0, 1),
	(2998, 0, 'Snowball Launcher', 'Sometimes it isn\'t enough to let Mother Nature take care of winter. Sometimes you\'ve just got to do it yourself. Especially when there needs to be a snowball fight. WARNING: Do Not Ingest.', 0, 130, 26, 26, 6, 0, 0, 1),
	(2999, 0, 'Marauder\'s Rigging', 'Do you like pink? And marauding? Then the Marauder\'s Rigging costume is for you! Get dolled up and rampage across the galaxy in your very own fear-inducing Marauder costume.', 0, 28, 27, 26, 11, 20, 0, 1),
	(3000, 0, 'Trapper Camp FABkit', 'Ever wanted to just get away from it all? Then the Trapper Camp FABkit is for you!  This purchase is for a single character only.', 0, 82, 79, 26, 8, 65, 0, 1),
	(3001, 1, 'Housing Sky - Pulp Starfield', 'Life in technicolor can be so passe. Get back to basics with this glorious black and white sky!', 1757, 81, 79, 26, 10, 71, 0, 1),
	(3002, 1, 'Housing Sky - Outer Space Opera', 'Need a little noir in your life? Look no further than the Outer Space Opera sky!', 1758, 81, 79, 26, 8, 69, 0, 1),
	(3003, 0, 'Chariot of the Krogg', 'Words cannot adequately describe the triumph of engineering that is the Chariot of the Krogg. With its intimidating profile, you\'ll be feared by all. Did we mention the incredible gas mileage?', 0, 33, 31, 26, 17, 30, 0, 1),
	(3006, 0, 'Disco-a-GoGo Bundle', 'All the boogy for one low price! This bundle includes One (1) Discotron, and one (1) GoGo Costume. Disclaimer: cannot guarentee that everyone will be \'jealous of your boogy\'.', 0, 26, 26, 26, 0, 0, 0, 1),
	(3018, 0, 'Petrol Prism Dye', 'Petrol Prism dye is a neutral prismatic dye destined to make even the most blah costume feel new. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 20, 9, 0, 1),
	(3019, 0, 'Aged Lavender Dye', 'A pearlescent neutral dye with the barest hint of purple. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 26, 18, 0, 1),
	(3020, 0, 'Rustic Bronze Dye', 'A pearlescent dye with an understated bronze hue. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 25, 19, 0, 1),
	(3021, 0, 'Glacier Blue Dye', 'Radiate the chill of icebergs in the northern reaches with this frosted aquamarine dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 24, 16, 0, 1),
	(3022, 0, 'Blue Flame Dye', 'This dye is so cold it burns! This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 23, 15, 0, 1),
	(3023, 0, 'Cerulean Underglow Dye', 'A dark mysterious blue dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 21, 11, 0, 1),
	(3024, 0, 'Violet Underglow Dye', 'A dark mysterious purple dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 22, 12, 0, 1),
	(3025, 0, 'Emerald Flame Dye', 'Golden green flames reminiscent of a fireworks display. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 17, 7, 0, 1),
	(3026, 0, 'Neon Fire Dye', 'Stand out from the crowd and, well, everything with the brilliant glory of Neon Fire dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 18, 8, 0, 1),
	(3027, 0, 'Geomantic Body Aura', 'Coat yourself in the armored power of earth with the Gromentic Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3028, 0, 'Infernal Body Aura', 'Your fashion sense will be on fire (literally!) with the Infernal Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 3, 0, 0, 1),
	(3029, 0, 'Superchilled Body Aura', 'You\'ll be as cold as ice with the Superchilled Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 4, 0, 0, 1),
	(3030, 0, 'Verdant Body Aura', 'Infuse your body with the lifeforce of growing things with the Verdant Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 2, 0, 0, 1),
	(3031, 0, 'Inspiring Body Aura', 'Allow the power of logic to inspire you to new heights of knowledge with the Inspiring Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3032, 0, 'Tempestuous Body Aura', 'Call upon the might of the storm with the Tempestuous Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3033, 0, 'Dynamic Body Aura', 'Harness red lightning with the Dynamic Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3034, 0, 'Ethereal Body Aura', 'Coat yourself with a protective layer of loftite. WARNING: Will not levitate. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3035, 0, 'Mystical Body Aura', 'Call upon mystical forces of Nexus with the Mystical Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3036, 0, 'Umbral Body Aura', 'Coat yourself in the concealing powers of darkness with the Umbral Body Aura. This purchase can only be applied to a single character.', 0, 130, 26, 26, 1, 0, 0, 1),
	(3037, 0, 'Landscape Garden FABkit', 'Enjoy the tranquility of the distant countryside from the safety of your own home. Once claimed, use this item to permanently unlock the Landscape Garden option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 1, 3, 0, 1),
	(3038, 1, 'Darkspur Chariot (White)', 'This Darkspur Chariot might be whitewashed but there\'s still a little pink showing through. White tipped chrome trim and the urge to break kneecaps come standard.', 0, 33, 31, 26, 1, 1, 0, 1),
	(3041, 0, 'Darkspur Chariot (Black)', 'Everyone\'s favorite Krogg inspired vehicle is back … in black!', 0, 33, 31, 26, 14, 26, 0, 1),
	(3047, 0, 'Sky Remodel: April Showers', 'Shower your housing  plot with the gentle rains of spring. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 1, 2, 0, 1),
	(3048, 0, 'Ground Remodel: May Flowers', 'Fill your housing plot with the yellow flowers of spring. This purchase can only be claimed by a single character.', 0, 81, 79, 26, 2, 2, 0, 1),
	(3049, 1, 'Love Launcher Toy', 'Shower your friends (and enemies) with the power of love (and rainbows)! This purchase can only be claimed by a single character.', 0, 132, 130, 26, 102, 5, 0, 1),
	(3050, 1, 'Loverboard', 'Ride on wings of love aboard the all new Loverboard!', 0, 132, 32, 31, 100, 1, 29, 1),
	(3053, 0, 'Wise Guy Getup', 'Show \'em that you\'ve got an offer they can\'t refuse in this authentic wise guy getup. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 9, 4, 0, 1),
	(3054, 0, 'Racy Costume', 'Show off your character\'s curves with this skintight costume. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 8, 6, 0, 1),
	(3055, 0, 'Gunsmoke Garb', 'Get your steampunk on with the Gunsmoke Garb costume. These items can be imported into the Holo-Wardrobe for all characters on your account.', 0, 28, 27, 26, 7, 13, 0, 1),
	(3056, 0, 'Circle of Life Weapon Set', 'Harness the primal power of Life. This vanity weapon set contains six weapons - one for each class. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 0, 29, 27, 26, 1, 17, 0, 1),
	(3057, 0, 'Spring Topiary Décor Pack', 'Everyone\'s favorite landscaping pack is back with fresh blooming flowers. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 26, 26, 2, 0, 0, 1),
	(3058, 0, 'Elegant Holding Pouch', 'Everyone has a holding pouch, but not everyone has an elegant one. Seventeen sumptuous slots of inventory space for, well, whatever you want.', 1471, 37, 35, 26, 1, 24, 0, 1),
	(3064, 0, 'Prismatic Dye', 'Coat yourself in the iredescent shimmers of purple, blue, and green hues. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 19, 10, 0, 1),
	(3080, 0, 'Martial Artist Apparel', 'Take a flying leap kick at life in this stylish fighting attire. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 0, 28, 27, 26, 10, 14, 0, 1),
	(3081, 0, 'Techno-Phage Spider Rider', '"It was a one-eyed, one-horned, crawling purple-- spider-rider?" Take a ride on the purple side with this violet monstrosity. ', 0, 33, 31, 26, 15, 28, 0, 1),
	(3084, 0, 'Hoverboard (Vampyre)', 'The perfect vehicle for those with an unquenchable thirst for speed.', 0, 32, 31, 26, 1, 27, 0, 1),
	(3087, 1, 'Accident Prone Hat', 'Running with scissors is never a smart decision, but owning this hat might be.', 0, 215, 27, 26, 1, 1, 0, 1),
	(3088, 0, 'Velocirex (Contagion)', 'Fresh from the fetid fields of Grismara, this velocirex will make all your undead dreams come true.', 0, 33, 31, 26, 13, 23, 0, 1),
	(3091, 0, 'Trask Tenderling (Mordesh)', 'That face! Those eyes! So cute you could just die! *thud*', 0, 78, 26, 26, 1, 0, 0, 1),
	(3094, 0, 'Smooth Phage Dye', 'Dress up in a smooth violet hue. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 16, 5, 0, 1),
	(3095, 0, 'Vibrant Violet Dye', 'Va va va vibrant purple dye perfect for standing out in a crowd. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 15, 3, 0, 1),
	(3096, 0, 'Hoverboard (Hound) (Gold Nugget)', 'All that is gold does not glitter - but the Gold Nugget certainly does!', 0, 32, 31, 26, 1, 25, 0, 1),
	(3099, 0, 'Augmented Fire Dye', 'Green dye augmented by the finest of pigments. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 14, 2, 0, 1),
	(3100, 0, 'Mechari Gold Dye', 'Sometimes you just need a light dusting of gold. That\'s where Mechari Gold Dye comes in. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 13, 1, 0, 1),
	(3101, 0, 'Beast Flesh Dye', 'A sandy, dun colored hue, Beast Flesh dye rides the line between yellow and brown. Perfect for those looking to blend in. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 12, 1, 0, 1),
	(3102, 0, 'Royal Yellow Dye', 'A gentle blend of lavender and vanilla hues. DO NOT DRINK! This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 11, 1, 0, 1),
	(3103, 0, 'Imperial Yellow Dye', 'This purple and yellow combination is ideal for anyone wishing to make a dramatic statement. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 10, 1, 0, 1),
	(3104, 0, 'Grismaran Attire', 'Not to be outdone by the fashions of other species, our Mordesh friends have come up with death defying fashions.', 0, 28, 27, 26, 6, 1, 0, 1),
	(3109, 1, 'Shared Realm Bank Slot', 'Unlock access to (1) one new row of storage space within the Shared Realm Bank system (NOTE: You must have already unlocked access to the Shared Realm Bank in order to use this purchase). This is a multi-redeem purchase that applies to all characters on your account.', 0, 37, 35, 26, 1, 1, 0, 1),
	(3110, 1, 'Shared Realm Bank Unlock', 'Unlock access to the shared realm Bank system as well as (2) rows of new storage space. This is a multi-redeem purchase that applies to all characters on your account.', 0, 37, 35, 26, 1, 1, 0, 1),
	(3118, 1, 'Pumera (Exotic)', 'Stand out in any crowd astride this fetching pumera from parts unknown. ', 0, 33, 31, 26, 12, 22, 0, 1),
	(3121, 0, 'Sky Remodel: Summer Sky', 'If you\'re looking for an endless summer, this is the sky for you. This purchase can only be claimed by a single character. ', 0, 81, 79, 26, 1, 1, 0, 1),
	(3122, 0, 'Ground Remodel: Summer Sand', 'Feel free to frolic in summer fields and feel the sun on your face. This purchase can only be claimed by a single character. ', 0, 81, 79, 26, 1, 1, 0, 1),
	(3123, 1, 'Surfboard Sampler Pack', 'Surf\'s up, so make sure you have the proper stick for those sick waves. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 1, 1, 0, 1),
	(3124, 1, 'Alien Décor Pack', 'Propel your plot out of this world with these extraterrestrial accessories. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 1, 1, 0, 1),
	(3125, 0, 'Deep Diver Diving Suit', 'Take to the depths in this utilitarian diving suit, but watch out for Ikthians! These items can be imported into the Holo-Wardrobe for all characters on your account. ', 0, 28, 27, 26, 5, 1, 0, 1),
	(3126, 1, 'Surfside Seashell FABkit', 'What\'s a shoreline without a suitable seashell?  Once claimed, use this item to permanently unlock the Surfside Seashell option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 1, 1, 0, 1),
	(3127, 1, 'Underwater Décor Pack', 'You won\'t need scuba gear to gaze at these subaquatic succulents. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 1, 1, 0, 1),
	(3128, 1, 'Uniblade (Green)', 'Your friends will be green with envy when they see you riding this unique uniblade. ', 0, 33, 31, 26, 11, 21, 0, 1),
	(3132, 1, 'Equivar (Technophage)', 'This augmented equivar is infected with a style that never goes out of fashion. ', 0, 33, 31, 26, 10, 20, 0, 1),
	(3138, 1, 'Mordesh Décor Pack', 'At long last there is a décor pack worthy of those who nest within death\'s embrace. Crafted by the finest (surviving) Grismaran artisans. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 26, 26, 1, 0, 0, 1),
	(3141, 1, 'Berserker (Aquatic) Hoverboard', 'Take a ride on the shoreline with this special Berserker hoverboard. ', 0, 32, 31, 26, 1, 1, 0, 1),
	(3156, 1, 'GoGo (Bubble Gum) Hoverboard', 'The Bubble Gum GoGo hoverboard is for riding, not chewing. ', 0, 32, 31, 26, 1, 19, 0, 1),
	(3171, 1, 'Hound (Azure) Hoverboard', 'Shades of azure compliment the strong lines of the Hound hoverboard.', 0, 32, 31, 26, 1, 18, 0, 1),
	(3177, 1, 'Ringer (Platinum) Hoverboard', 'Platinum and gold bump this Ringer hoverboard to the next level of luxury. Ding! ', 0, 32, 31, 26, 1, 1, 0, 1),
	(3180, 1, 'Ringer (Avatus) Hoverboard', 'The Caretaker\'s evil alter-ego is immortalized in the colors of this Ringer hoverboard. ', 0, 32, 31, 26, 1, 17, 0, 1),
	(3186, 1, 'Ringer (Halcyon) Hoverboard', 'Few hoverboards are as smooth-riding or soothing  as the Halcyon Ringer. ', 0, 32, 31, 26, 1, 16, 0, 1),
	(3209, 0, 'Fancy Pants Decor Pack', 'Exquisitely-crafted and painstakingly finished décor for the discerning homeowner. Protostar is proud to make this offer to everyone, rather than to a select and privileged few. ', 0, 80, 79, 26, 1, 1, 0, 1),
	(3211, 0, 'Sanguine Brass Dye', 'Revel in the luscious gold and scarlet combination that is Sanguine Brass. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 8, 1, 0, 1),
	(3212, 1, 'Consort\'s Woolie ', 'Ride into battle astride a verdant furred woolie, like those preferred by the Matria\'s own consort.', 0, 132, 33, 31, 34, 9, 14, 1),
	(3215, 1, 'Matria\'s Woolie ', 'The Matria\'s Woolie is a mount fit for royalty!', 0, 132, 33, 31, 33, 8, 13, 1),
	(3218, 0, 'Urban Camo Dye', 'Blend into the concrete jungle with this intense grey hue. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 9, 1, 0, 1),
	(3220, 1, 'Primal Strider', 'Project pure primal power while traveling Nexus atop your own crystalline strider.', 0, 33, 31, 26, 4, 12, 0, 1),
	(3223, 0, 'Metal Maniac Costume', 'Slam, bash, and thrash your way across the galaxy in style. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 0, 28, 27, 26, 4, 1, 0, 1),
	(3224, 0, 'Terminites Attack Decor Pack', 'These terminites wood love to set up a new home in your housing plot. Don\'t pass up this amazing new infestment opportunity! This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 80, 79, 26, 1, 1, 0, 1),
	(3225, 1, 'Sky Remodel: Autumn Leaves', 'Welcome autumn\'s arrival with bright skies and falling leaves. This purchase can only be claimed by a single character. ', 0, 81, 79, 26, 1, 1, 0, 1),
	(3226, 1, 'Ground Remodel: Golden Harvest', 'Celebrate harvest season with fields of golden grain. This purchase can only be claimed by a single character. ', 0, 81, 79, 26, 1, 1, 0, 1),
	(3227, 1, 'Velocirex (Ebon)', 'Astride the sleek and dangerous form of the Ebon Velocirex, you will command the attention of friend and foe alike.', 0, 33, 31, 26, 7, 11, 0, 1),
	(3230, 1, 'Lazarin\'s Laboratory FABkit', 'Grab your lab coat and safety goggles and carry out your secret experiments inside Victor Lazarin\'s own lab. Once claimed, use this item to permanently unlock the Lazarin\'s Laboratory option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 1, 1, 0, 1),
	(3231, 0, 'Moon Mariner Uniform', 'Suit up, assemble your team, and defend Nexus from the forces of evil in the Moon Mariner Uniform. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 0, 28, 27, 26, 2, 1, 0, 1),
	(3232, 1, 'Industrial BoreBot (Red)', 'Attention! This is not a drill! It\'s TWO drills attached to a burly BoreBot just waiting for a pilot.', 0, 33, 31, 26, 6, 10, 0, 1),
	(3236, 0, 'Augmented Bark Dye', 'Unleash your inner adventurer with this rugged, rustic hue. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 7, 1, 0, 1),
	(3237, 0, 'Emerald Underglow Dye', 'This sleek green dye adds an Eldan flair to any ensemble. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 6, 1, 0, 1),
	(3238, 0, 'Borealis Purple Dye', 'Embark upon a cosmic journey with this dark celestial hue. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 5, 1, 0, 1),
	(3239, 0, 'Orange Sherbet Dye', 'Stay cool during hot Nexus summers with this dye inspired by a tasty treat. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 39, 27, 26, 4, 1, 0, 1),
	(3240, 1, 'Velocirex (Electrified)', 'Looking for a spooky mount with shock value? This velocirex has everything you need!', 0, 132, 33, 31, 74, 5, 9, 1),
	(3265, 0, 'Torine Builder\'s Decor Pack', 'Transform your plot into a tranquil Torine temple with this builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 64, 1, 1, 1),
	(3267, 0, 'Protostar Builder\'s Decor Pack', 'Skip all the red tape and buy your home improvements straight from the source with this Protostar builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 44, 1, 1, 1),
	(3268, 0, 'Exile Builder\'s Decor Pack', 'Show off your rebellious side with this Exile builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 63, 1, 1, 1),
	(3269, 0, 'Dominion Builder\'s Decor Pack', 'Show off your devotion to the Emperor with this patriotic Dominion builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 62, 1, 1, 1),
	(3270, 0, 'Exo-Lab Builder\'s Decor Pack', 'Delve into the secrets of Nexus with this Exo-Lab builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 57, 1, 1, 1),
	(3271, 0, 'Shrine Builder\'s Decor Pack', 'Create your own private sanctuary with this Shrine builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 58, 1, 1, 1),
	(3272, 0, 'Osun Builder\'s Decor Pack', 'Bulk up your living space with this massive Osun builder\'s pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character.', 0, 132, 80, 79, 61, 1, 1, 1),
	(3273, 1, 'Technophage Convergence FABkit', 'Harness the power of the Technophage in the privacy of your own home.  Once claimed, use this item to permanently unlock the Technophage Convergence option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 1, 1, 0, 1),
	(3312, 1, 'Ho Ho Ho Mobile (Green)', 'One part reindeer, one part sleigh, the Ho Ho Ho Mobile (Green)  is perfect for those who wish to spread holiday cheer. ', 0, 132, 33, 31, 30, 1, 1, 1),
	(3315, 1, 'Ho Ho Ho Mobile (Blue)', 'The blue variant of the infamous holiday mount, the Ho Ho Ho Mobile (Blue) provides a calm yet festive ride. ', 0, 132, 33, 31, 28, 2, 1, 1),
	(3318, 1, 'Ho Ho Ho Mobile (Gold)', 'All that is gold does not glitter. But the Ho Ho Ho Mobile (Gold) sure does. It glitters in spades. Warning: Drool may be present. ', 0, 132, 33, 31, 27, 3, 1, 1),
	(3327, 1, 'Sky Remodel: Cotton Candy', 'The Cotton Candy sky is a pink glittering accoutrement for those who want to add a more dreamlike feel to their housing plot. This purchase can only be claimed by a single character. ', 0, 132, 81, 79, 39, 1, 1, 1),
	(3328, 1, 'Model Gingerbread House FABkit', 'Produces a Gingerbread House suited for sweet housing plots, that allows an additional structure on your plot that can be decorated outside. Once claimed, use this item to permanently unlock the Model Gingerbread House option in the Landscape menu of your housing plot. This purchase is for a single character only. ', 0, 132, 82, 79, 36, 1, 1, 1),
	(3329, 1, 'Gingerbread Trim Decor Pack', 'Trim your Gingerbread buildings with the contents of this sweet, sweet décor pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character. ', 0, 132, 80, 79, 37, 1, 1, 1),
	(3330, 1, 'Gingerbread Construction Decor Pack', 'Build your own gingerbread housing with the Gingerbread Construction décor pack. This decor pack includes all of the decor items shown below and can only be claimed by a single character. ', 0, 132, 80, 79, 38, 1, 1, 1),
	(3332, 1, 'Cheer Gear Costume', 'Get ready for the retail rush that accompanies the holidays with the Cheer Gear costume. These items can be imported into the Holo-Wardrobe for all characters on your account. ', 0, 132, 28, 27, 17, 1, 1, 1),
	(3336, 1, 'Auroria Pine Dye', 'Show your support for the farmers of Auroria with this verdant green dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 132, 39, 27, 43, 3, 1, 1),
	(3337, 1, 'Crimson Curtain Dye', 'You\'ll be the star of the show when you don this brillant red dye! This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 132, 39, 27, 42, 1, 1, 1),
	(3338, 1, 'Rustic Sand Dye', 'Take the beach with you on your travels when wearing this bucolic dye. This purchase is a multi-redeem item which can be claimed by all characters on your account.', 0, 132, 39, 27, 41, 2, 1, 1),
	(3342, 8, '88-Proof Boardwax', 'Hop on the board and keep moving. You might see some serious trouble. This purchase can only be applied to a single character.', 0, 132, 130, 26, 60, 1, 0, 1),
	(3343, 1, 'Grim Hood', 'Don this fearsome visage and haunt Nexus in style. This item can be imported into the Holo-Wardrobe for all characters on your account.', 0, 26, 26, 26, 0, 0, 0, 1),
	(3386, 1, 'Pumera (Frostbite)', 'This fierce and frosty feline is the perfect mount for all your winter adventures.', 0, 132, 33, 31, 10, 1, 1, 1),
	(3389, 1, 'Frozen Pond FABkit', 'This picturesque pond can be a serene retreat or landmark in your winter wonderland.  Once claimed, use this item to permanently unlock the Frozen Pond option in the Landscape menu of your housing plot. This purchase can only be claimed by a single character.', 0, 82, 79, 26, 1, 1, 0, 1);
