namespace NexusForever.WorldServer.Game.Quest.Static
{
    ...
    // Observations: When data = 0, it appears to be completed by script. Touring Tremor Ridge (Quest ID: 9164) has 2 objectives which have data values of 0 - Interacting with Taxi Stand, and Interacting with Mailbox.
}
