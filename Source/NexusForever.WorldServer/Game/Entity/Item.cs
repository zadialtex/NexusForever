    ...
    public class Item : ISaveCharacter
    {
        ...
        public Item(ItemModel model)
        {
            ...
            if ((InventoryLocation)model.Location != InventoryLocation.Ability)
            {
                ...
                InnateProperties = AssetManager.GetInnateProperties((ItemSlot)GameTableManager.ItemType.GetEntry(Entry.Item2TypeId).ItemSlotId, Entry.PowerLevel, Entry.Item2CategoryId, Entry.SupportPowerPercentage);
            }   
            else
